...
Name: "KKManager";                             Description: "KKManager v0.22.0.0 (Manage and update mods, browse cards)"                           ; Types: full_en full extra extra_en custom bare
; -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
...
Name: "AT\TL\Subtitles";                       Description: "Subtitles v0.1 (Show subtitles for girl's voice in H-Scenes)"                         ; Types: extra_en
; -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
...
Name: "Feature\Gravure";                       Description: "Gravure plugin v1.0 (More posing options in character maker, press G)"                ; Types: full_en full extra extra_en
Name: "Feature\ColorPanelX";                   Description: "ColorPanelX v1.4.3 (Improves maker color picker)"                                     ; Types: full_en full extra extra_en
Name: "Feature\RG_PovX";                       Description: "PovX v0.0.3 (Adds first-person view in H scenes, check hotkeys in plugin settings (F5))"; Types: full_en full extra extra_en
...
Name: "Feature\Workaholics";                   Description: "Workaholics v1.0.0 (Force male characters to load in at their workplaces after time changes)"
...
Name: "Feature\HSceneCrowdReaction";           Description: "HSceneCrowdReaction v0.5.3 (Give characters different reactions when seeing a H scene instead of only being awkward)"
; -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
